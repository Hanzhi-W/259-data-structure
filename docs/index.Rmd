...
---
`r chunk_reveal("pivotlong", break_type = "rotate", float = "none", widths = c(15, 1))`

```{r pivotlong, include = FALSE}
ds <- read_csv('data_cleaned/vocab_annoying_headers.csv') %>% 
  mutate(id = "Jonah", dob = as.Date("2017-08-30"), .before = "age_12")
...
---
`r chunk_reveal("join", break_type = "rotate", float = "none", widths = c(8, 1), title = "# Joining by key value")`
